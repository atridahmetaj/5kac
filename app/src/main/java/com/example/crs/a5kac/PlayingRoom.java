...
public class PlayingRoom extends Activity {
  private final String[] cardNames = {
     ...
     "s2", "s3", "s4", "s5", "s6", "s7", "s8", "s9", "s10", "sj", "sq", "sk", "sa",
      "blue_back", "gray_back", "green_back", "purple_back", "red_back", "yellow_back"
  };
  ...
  private void setupCards() {
    for (String card : cardNames) {
      ...
      cards.put(card, new Card(PlayingRoom.this, imageId));
    }
  }

  protected void splitCards() {
    setupCards();
    linearLayout.addView(cards.get("red_back"));
  }
